...

                {
                    ...
                    <div className=" pl-0 lg:pl-10">
                        ...
                        <p className="text-sm font-thin text-gray-300 mb-4 ">
                            BreakerDAO is a hypothetical decentralized autonomous organization (DAO) that could potentially exist on the Waves blockchain or another blockchain platform.{" "}
                            <br />
